...
const Join: React.FC<JoinProps> = () => {
  ...
  return (
    <section className="relative pb-[60px] pt-6 tablet:pb-[130px] tablet:pt-8 desktop:pb-[100px] desktop:pt-8">
      ...
      <JoinForm />
      <div className="-right-5 hidden tablet:absolute tablet:bottom-[90px] tablet:block tablet:h-[82px] tablet:w-[182px] tablet:bg-[url('/assets/images/Help/Join/Vector1.png')] tablet:bg-cover tablet:bg-center tablet:bg-no-repeat desktop:bottom-14 desktop:h-[192px] desktop:w-[1032px]" />
      <div className="-right-8 hidden tablet:absolute tablet:bottom-[120px] tablet:block tablet:h-[206px] tablet:w-[192px] tablet:bg-[url('/assets/images/Help/Join/Vector2.png')] tablet:bg-cover tablet:bg-center tablet:bg-no-repeat desktop:bottom-14 desktop:h-[192px] desktop:w-[1032px]" />
