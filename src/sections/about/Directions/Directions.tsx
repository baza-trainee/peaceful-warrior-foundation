      ...
      <section className={styles.animationBlock}>
        <article className="flex flex-col justify-center items-center tablet:flex-row desktop:justify-end desktop:pb-[140px]">
          ...
          <div className="bg-card-background px-8 py-4 rounded-b-2xl shadow-card-shadow tablet:w-[480px] tablet:px-12 tablet:py-8 tablet:rounded-l-[0px] tablet:rounded-r-3xl desktop:py-9 desktop:w-[675px] desktop:h-[196px]">
            <h5 className='text-md text-center leading-6 font-medium pb-2 tablet:font-lg tablet:text-left tablet:leading-[32px] tablet:pb-3 desktop:leading-[36px] desktop:text-2xl desktop:font-regular desktop:pb-4'>Протезування</h5>
        ...
        <article className="flex flex-col justify-center items-center tablet:flex-row-reverse desktop:pb-[140px] desktop:justify-end">
          ...
          />
          <div className="bg-card-background px-8 py-4 rounded-b-2xl shadow-card-shadow tablet:rounded-r-[0px] tablet:rounded-l-3xl tablet:w-[480px] tablet:px-12 tablet:py-8 desktop:w-[675px] desktop:h-[196px] desktop:py-9 ">
            <h5 className='text-md text-center leading-6 font-medium pb-2 tablet:font-lg tablet:text-left tablet:leading-[32px] tablet:pb-3 desktop:leading-[36px] desktop:text-2xl desktop:font-regular desktop:pb-4'>Правова допомога</h5>
        ...
        <article className="flex flex-col items-center justify-center tablet:flex-row desktop:justify-end">
          ...
          width={331}
          height={220}
          className="rounded-t-2xl outline outline-2 outline-gray-border outline-offset-4 max-h-[206px] w-[321px] object-none object-top mb-3.5 grayscale tablet:mb-0 tablet:rounded-tr-[0px] tablet:rounded-l-3xl tablet:w-[188px] tablet:h-[156px] desktop:max-h-[185px] desktop:w-[227px]"
          />
          <div className="bg-card-background px-8 py-4 rounded-b-2xl shadow-card-shadow tablet:w-[480px] tablet:px-12 tablet:py-8 tablet:rounded-l-[0px] tablet:rounded-r-3xl desktop:w-[675px] desktop:h-[196px]">
            <h5 className='text-md text-center leading-6 font-medium pb-2 tablet:font-lg tablet:leading-[32px] tablet:text-left tablet:pb-3 desktop:leading-[36px] desktop:text-2xl desktop:font-regular desktop:pb-4'>Психологічна допомога</h5>
